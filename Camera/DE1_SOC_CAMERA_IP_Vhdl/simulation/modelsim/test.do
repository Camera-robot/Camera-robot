...
#sim:/image_process/bi \
#sim:/image_process/gi \
#sim:/image_process/nbi \
#sim:/image_process/ngi \
#sim:/image_process/nri \
#sim:/image_process/ri
force -freeze sim:/image_process/VGA_CLK 1 0, 0 {50 ps} -r 100
force -drive sim:/image_process/reset U 0
