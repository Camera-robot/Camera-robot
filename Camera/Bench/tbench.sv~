...
pixel_t img_vga    [int][int]; 
pixel_t img_vga_2    [int][int];
...
barycentre pos (
  ...
  // Pixel luminescance value coming from DRPAM (~ Camera)
  .r_bary       (img_out.r), // Input Red Pixel
  .g_bary       (img_out.g), // Input Green Pixel
  .b_bary       (img_out.b), // Input Blue Pixel
...
initial begin
  read_bmp(img_camera,"./img/test_dro_512x512.bmp");//selection image
end
